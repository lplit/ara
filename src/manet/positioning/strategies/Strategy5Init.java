...
public class Strategy5Init implements InitialPositionStrategy {
	...
	public Position getInitialPosition(Node host) {
		if(initial_position==null) {
			...
			for(int i=0;i< Network.size();i++) {
				...
				if(initial_position.size()==0) {
					...
					initial_position.put(n.getID(), new Position( CommonState.r.nextDouble()*(max_distance_x-min_distance_x)+min_distance_x, 
		...
		//System.out.println("Node "+host.getID()+" init_position = "+initial_position.get(host.getID()));
