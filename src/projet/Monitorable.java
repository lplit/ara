...
public interface Monitorable extends Protocol{
	...
	public default int getState(Node host) {return 0;}
	
	/*permet d'obtenir une liste de chaine de caractère, affichable en colone à coté du noeud sur un moniteur graphique*/
